...
export const SIZE_PRESETS: Record<string, SizePreset> = {
  ...
  comic_sixth_grid: {
    ...
    aspectRatio: 0.94, // Standard 6-grid panel (slightly taller than square)
    dimensions: {
      sdxl: { width: 1024, height: 1088 },
      sd15: { width: 496, height: 512 },
      flux: { width: 1024, height: 1088 },
    },
  ...
  instagram_portrait: {
    ...
    aspectRatio: 0.82,
    dimensions: {
      sdxl: { width: 896, height: 1088 },
      sd15: { width: 416, height: 512 },
      flux: { width: 896, height: 1088 },
    },
