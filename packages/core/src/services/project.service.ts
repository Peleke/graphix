...
import { projects, type Project, type NewProject, type ProjectSettings } from "../db/index.js";
...
/**
 * Create a new ProjectService with explicit database injection
 */
export function createProjectService(db: Database): ProjectService {
  return new ProjectService(db);
}

/**
 * Get the singleton ProjectService (uses default database)
 */
