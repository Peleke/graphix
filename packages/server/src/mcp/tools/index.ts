...
const handlers: Record<string, (name: string, args: Record<string, unknown>) => Promise<unknown>> = {
  ...
  // Story scaffold tools (Phase 4)
  story_scaffold: handleStoryTool,
  story_from_outline: handleStoryTool,
  story_parse_outline: handleStoryTool,

  // Batch tools (Phase 4)
  panels_create_batch: handleBatchTool,
  panels_delete_batch: handleBatchTool,
  captions_add_batch: handleBatchTool,
  captions_clear_batch: handleBatchTool,
  panels_generate_batch: handleBatchTool,
  panels_generate_variants_batch: handleBatchTool,
  panels_render_captions_batch: handleBatchTool,
