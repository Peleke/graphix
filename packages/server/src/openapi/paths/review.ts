...
export const reviewPaths: Record<string, any> = {
  "/review/images/{imageId}": {
    get: {
      ...
      responses: {
        "200": { description: "Review found", content: { "application/json": { schema: { $ref: "#/components/schemas/ImageReview" } } } } },
        "400": { description: "Invalid image ID format", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } },
    ...
    post: {
      ...
      parameters: [{ name: "imageId", in: "path", required: true, schema: { type: "string" } }],
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/ReviewImage" } } } },
      responses: {
        "200": { description: "Review completed", content: { "application/json": { schema: { $ref: "#/components/schemas/ReviewResult" } } } } },
  ...
  "/review/panels/{panelId}/auto": {
    post: {
      ...
      parameters: [{ name: "panelId", in: "path", required: true, schema: { type: "string" } }],
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/ReviewConfig" } } } },
      responses: {
  ...
  "/review/storyboards/{id}": {
    post: {
      ...
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/BatchReview" } } } },
      responses: {
        "200": { description: "Batch review completed", content: { "application/json": { schema: { $ref: "#/components/schemas/BatchReviewResult" } } } } },
        "400": { description: "Validation error", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } },
      },
    },
  },
  "/review/queue": {
    get: {
      ...
      responses: {
        "200": { description: "Review queue", content: { "application/json": { schema: { $ref: "#/components/schemas/PaginatedReviewQueue" } } } } },
      },
    },
  },
  "/review/queue/{reviewId}/approve": {
    post: {
      ...
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/ApproveImage" } } } },
      responses: {
  ...
  "/review/queue/{reviewId}/reject": {
    post: {
      ...
      parameters: [{ name: "reviewId", in: "path", required: true, schema: { type: "string" } }],
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/RejectImage" } } } },
      responses: {
  ...
  "/review/queue/{reviewId}/regenerate": {
    post: {
      ...
      parameters: [{ name: "reviewId", in: "path", required: true, schema: { type: "string" } }],
      requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/RegenerateImageReview" } } } },
      responses: {
        "200": { description: "Image regenerated", content: { "application/json": { schema: { $ref: "#/components/schemas/ReviewResult" } } } } },
        "400": { description: "Validation error", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } },
        "404": { description: "Review not found", content: { "application/json": { schema: { $ref: "#/components/schemas/Error" } } } } },
      },
    },
